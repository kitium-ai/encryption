...
- Security primitives including Argon2id/scrypt derivation, zeroization, and constant-time comparison.
- Configuration schema validation, audit sinks, and documentation updates.
